...
//		Employeeクラスの変数なので、Employeeクラスに追加したgetEmployeeProfileメソッドの呼び出し可能
		System.out.println("Employeekクラスのメソッド：プロフィールを紹介します。" + tanaka.getEmployeeProfile());
		
//		printNameメソッドを呼び出して名前を表示
